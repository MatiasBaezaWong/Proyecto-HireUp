...
urlpatterns = [
    ...
    path("exportar_postulaciones_excel/", views.exportar_postulaciones_excel, name="exportar_postulaciones_excel"),
    path("generar_informe_postulaciones_pdf/", views.generar_informe_postulaciones_pdf, name="generar_informe_postulaciones_pdf"),
